...
PLAY_2_0_HOME=${DEV_SOFTWARE_HOME}/Play/play-2.0.4
PLAY_2_1_HOME=${DEV_SOFTWARE_HOME}/Play/play-2.1.0
export PLAY_HOME=${PLAY_2_1_HOME}
export JREBEL_HOME=$DEV_SOFTWARE_HOME/JRebel/jrebel-5.1.2

### Windows special modification (Remove this if Linux/Mac) ###
